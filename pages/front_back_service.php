...
<head>
    ...
    <title>Frontend and Backend Services</title>
</head>

<body>
    <section class="fbend_service_seller services_seller">
        <div class="content_fbend_service content_services">
            <div class="info_fbend_service info_services">
                <div class="btn_back"><a href="index.php"><i class="fa-solid fa-arrow-left"></i></a></div>
                <h3>KNOW MORE ABOUT OUR </h3>
                <h2>FRONT AND BACKEND SERVICES!</h2>
                <div class="content_fbend_img content_img_services">
            ...
            <div class="form_fbend_service form_services_content">
                <h2>Make your appointment</h2>
                <form action="front_back_service.php" method="post" class="form_fbend_service form_services" enctype="multipart/form-data">
                    <input type="date" name="date_input_services" id="date_input">
                    <br>
                    <select name="input_services" id="services_input">
                        <option value="Frontend Services">Frontend and Backend Services</option>
                    </select>
                    <br>
